...
- If a retrieved source is about a different technology or context than what the user asked 
  (e.g., pandas/numpy when the user asked about plain Python lists), ignore it and say you 
  couldn't find a direct answer rather than answering from the wrong context.
